...
import dev.bpmcrafters.processengineapi.adapter.c7.remote.task.completion.ClientExternalTaskServiceCompletionStrategy
 ...
 *
 */
class SubscribingExternalTaskServiceClientServiceTaskDelivery(
  ...
  fun subscribe() {
    subscriptionRepository.getTaskSubscriptions()
      .forEach { subscription ->
        if (ClientExternalTaskServiceCompletionStrategy.supports(subscription.restrictions)) {
